            ...
            <section class="widget login-widget">
                ...
                <div class="body">
                    <form class="no-margin"
                          action="index.php?mod=blogger&act=login_process" method="post">
                        <fieldset>
                        ...
                        <div class="form-actions">
                            ...
                            <a class="forgot" href="index.php?mod=blogger&act=register">Đăng ký?</a>
                        </div>
                    </form>
                </div>
                <footer>
                    <div class="facebook-login">
                        <a href="index.php?mod=user&act=home"><span>Quay lại trang chủ</span></a>
                    </div>
                </footer>
            </section>
        </div>
