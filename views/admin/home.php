                        ...
                        <div id="chat-messages" class="chat-messages">
                            ...
                            <div class="chat-message">
                                <div class="sender pull-right">
                                    <div class="icon">
                                        <img src="public/admin/img/1.jpg" class="img-circle" alt="">
                                    </div>
                                    <div class="time">
                                        3 min
                                    </div>
                ...
                <div class="body">
                    <div id="feed" class="feed">
                        <div class="wrapper">
                            ...
                            <section class="feed-item">
                                <div class="icon pull-left">
                                    <img src="public/admin/img/14.jpg" class="img-circle" alt="">
                                </div>
                                <div class="feed-item-body">
                                    <div class="text">
            ...
            <!-- <section class="widget widget-tabs">
                ...
                <div class="body tab-content">
                    <div id="stats" class="tab-pane active clearfix">
                        ...
                        <ul class="news-list">
                            <li>
                                <img src="public/admin/img/1.jpg" alt="" class="pull-left img-circle"/>
                            ...
                            <li>
                                <img src="public/admin/img/3.jpg" alt="" class="pull-left img-circle"/>
                                <div class="news-item-info">
                            ...
                            <li>
                                <img src="public/admin/img/2.jpg" alt="" class="pull-left img-circle"/>
                                <div class="news-item-info">
                            ...
                            <li>
                                <img src="public/admin/img/13.jpg" alt="" class="pull-left img-circle"/>
                                <div class="news-item-info">
                            ...
                            <li>
                                <img src="public/admin/img/14.jpg" alt="" class="pull-left img-circle"/>
                                <div class="news-item-info">
